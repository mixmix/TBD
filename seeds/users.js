...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('users').insert({id: 4, fullName: 'Tony Luisi' , passwordHash: bcrypt.hashSync('password', saltRounds), email: 't.luisi@gmail.com', styleRating: 3, connoisseurRating: 3, fbId: 10156915534565451, igId: 3})
  );
};
